...
function get_password(){ var jsString = document.querySelector("#password").value; var lengthBytes = lengthBytesUTF8(jsString)+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsString, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap; }
function send_message(flag){ document.querySelector("#flag").innerText = UTF8ToString(flag); }
